...
pip3 install future six typing requests ecdsa pefile Cython==3.0.11-1 setuptools
...
curl -LOC - https://github.com/knautilus/Utils/releases/download/v1.0/switch-libpython-3.9.2-1-any.pkg.tar.zst
...
rm switch-libpython-3.9.2-1-any.pkg.tar.zst
