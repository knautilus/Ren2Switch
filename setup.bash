...
curl -LOC - https://github.com/knautilus/Utils/releases/download/v1.0/python39-switch_d.zip
#dkp-pacman -U --noconfirm devkitpro-pkgbuild-helpers-2.2.4-2-any.pkg.tar.xz
unzip -qq python39-switch_d.zip -d $DEVKITPRO/portlibs/switch

#rm devkitpro-pkgbuild-helpers-2.2.4-2-any.pkg.tar.xz
rm python39-switch_d.zip
